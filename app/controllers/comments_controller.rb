class CommentsController < ApplicationController
  ...
  def edit
    begin
      ...
      if @comment.user == @current_user
        redirect_to post_slug_path(@comment.post.slug, :edit_comment => @comment, :anchor => "comment-#{@comment.id}")
      else
  ...
  def create
    ...
    respond_to do |format|
      if @comment.save
        format.html { redirect_to post_slug_path(@post.slug, :anchor => "comment-#{@comment.id}"), notice: 'Comment was successfully created.' }
